<template>
  <div class="container-wrapper">
    <main class="container">
      ...
      <h2 id="支持">支持</h2>
      <p>
        纯纯看番社区+ 采用<a href="LICENSE">MPL-2.0</a>许可发行源代码，如果你有什么新的功能或者建议，欢迎加入我们。
      </p>
      <h2 id="相关项目">相关项目</h2>
      <ul>
        <li>
          纯纯看番 -
          <a href="https://github.com/easybangumiorg/EasyBangumi">EasyBangumi</a>
        </li>
        <li>
          纯纯看番社区+ 后端 -
          <a href="https://github.com/easybangumiorg/Community-Plus/">Community-Plus</a>
        </li>
        <li>
          纯纯看番社区+ 管理前端 -
          <a href="https://github.com/easybangumiorg/Community-Plus-FrontEnd">Community-Plus-FrontEnd</a>
        </li>
        <li>
          纯纯看番社区+ 插件 -
          <a
            href="https://github.com/easybangumiorg/EasyBangumi-Extension-Community-Plus">EasyBangumi-Extension-Community-Plus</a>
        </li>
      </ul>
      <h2 id="许可">开源许可</h2>
      <p>该项目由 <a href="https://www.mozilla.org/en-US/MPL/2.0/">MPL-2.0</a> 许可发行。</p>
      <h2>隐私说明</h2>
      <p>
        本开源项目仅收集用户昵称、邮箱（如果用户提供）、头像地址及播放历史（用于推荐算法），并不会额外收集用户的其他个人信息。我们不会通过主体应用（纯纯看番）主动收集用户其他插件的数据。请注意，第三方社区服务可能有其自己的隐私政策，我们建议用户在使用这些服务时仔细阅读其隐私政策。
      </p>
      <h2>免责声明</h2>
      <p>
